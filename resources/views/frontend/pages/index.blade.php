                   ...
                   <div class="latest-news-section">
                       ...
                       <div class="row clearfix">
                           ...
                           <div class="news-block-two with-margin col-md-4 col-sm-6 col-xs-12">
                               <div class="inner-box">
                                   <div class="image">
                                       <a href="{{ route('frontend.articles', $article) }}"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="{{ asset(imagePath($article->image, 'articles')) }}" alt="" style="width:300px;height:200px;" /></a>

                                       <div class="category"><a href="#">{{ $article->category->name }}</a></div>
                                   </div>
                                   <h4><a href="{{ route('frontend.articles', $article) }}">{{ $article->title }}</a></h4>
                                   ...
                                   <div class="lower-box" style="padding: 0px;">
                                       ...
                                       <div class="text">{!! Str::limit($article->content, 90, '...') !!}
                                       </div>
                           ...
                           <div class="product-widget-tabs">
                               ...
                               <div class="prod-tabs tabs-box">
                                   ...
                                   <ul class="tab-btns tab-buttons clearfix">
                                       <li data-tab="#prod-popular" class="tab-btn active-btn">Trending</li>
                                           ...
                                           <div class="content">
                                              @foreach($trending_articles as $article)
                                               <article class="widget-post">
                                                   <figure class="post-thumb"><a href="{{ route('frontend.categories', $category) }}"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="{{ asset(imagePath($article->image, 'articles')) }}" style="width:86;height:79px;" alt=""></a>
                                                       <div class="overlay"></div>
                                                   </figure>
                                                   <div class="text"><a href="{{ route('frontend.categories', $category) }}">{{ Str::limit($article->title, 70, '..') }}</a></div>
